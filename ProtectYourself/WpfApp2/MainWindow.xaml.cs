...
namespace WpfApp2
{
    public partial class MainWindow : Window
    {
        ...
        {
            InitializeComponent();
            var update = new Updates("https://github.com/dwierzbicki11/gotoweProtYou.git",@"C:\protectYourself");
            polecenia.help();
        ...
        private void Send_OnClick(object sender, RoutedEventArgs e) {
            ...
            switch (dana) {
                case "?help":
                    ...
                    break;
                case "?info":
                    MessageBox.Show("Autor: Daniel Wierzbicki\nWersja:1.1v","Informacje",MessageBoxButton.OK,MessageBoxImage.Information);
                    break;
                case "?clear":
